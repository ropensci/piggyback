...
- Add the environment variable:
  - via project-specific Renviron: 
    - `usethis::use_git_ignore(".Renviron")` - update your gitignore to prevent 
    accidentally committing your token to GitHub
    - `usethis::edit_r_environ("project")` to open the Renviron file, and then 
    add your token, e.g. `GITHUB_PAT=ghp_a1b2c3d4e5f6g7`
  - via `Sys.setenv(GITHUB_PAT = "ghp_a1b2c3d4e5f6g7")` in your console for oneoff 
