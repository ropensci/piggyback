...
[GitHub allows](https://help.github.com/articles/distributing-large-binaries/) repositories to attach files of up to 2 GB each to releases as a way to distribute large files associated with the project source code.  There is no limit on the number of files or bandwidth to deliver them.  
